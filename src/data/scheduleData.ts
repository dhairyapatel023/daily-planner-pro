    ...
    items: [
      {
        ...
        subjectType: 'cloud',
        batches: [
          { batch: 'H10', subject: 'Cloud Architecture and Services Lab', faculty: 'Mahesh Kumar', room: 'E-202' },
          { batch: 'H11', subject: 'Cloud Architecture and Services Lab', faculty: 'Bablu Kumar', room: 'E-202' },
          { batch: 'H12', subject: 'Cloud Architecture and Services Lab', faculty: 'Deepak Sharma', room: 'E-202' },
        ],
      },
      {
        id: 'tue-3',
